export interface Product {
  ...
  export const products: Product[] = [
    ...
    },
    {
      ...
      description: {
        en: "This is a flat, V-shaped corner brace, presented in a sleek, matte dark gray finish. It features a precise 90-degree angle, with five pre-drilled holes strategically placed for secure fastening. The minimalist design and dark color make it a versatile and discreet option for reinforcing corners in furniture, frames, or other structural applications where a clean aesthetic is desired. \nAvailable in two sizes: \n90 × 20 × 1.3 mm, 70 × 20 × 1.3 mm.",
        fr: "Il s'agit d'une équerre plate en V, présentée dans une élégante finition gris foncé mat. Elle présente un angle précis de 90 degrés et cinq trous pré-percés stratégiquement placés pour une fixation sûre. Son design minimaliste et sa couleur foncée en font une option polyvalente et discrète pour renforcer les angles de meubles, de cadres ou d'autres applications structurelles nécessitant une esthétique épurée. \nDisponible en deux tailles : \n90 × 20 × 1,3 mm et 70 × 20 × 1,3 mm.",
      },
